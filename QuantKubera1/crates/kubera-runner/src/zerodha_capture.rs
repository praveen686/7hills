...
/// - Offset 44-48: Last trade time (uint32)
/// - Offset 48-52: OI (uint32)
/// - Offset 52-56: OI day high (uint32)
/// - Offset 56-60: OI day low (uint32)
/// - Offset 60-64: Exchange timestamp (uint32)
