//! Risk limits for funding arbitrage.
//!
//! Enforces exposure limits, basis divergence thresholds, and drawdown guards.
...
pub struct RiskLimits {
    ...
    /// Maximum basis divergence in bps before forced exit
    pub max_basis_divergence_bps: f64,
}
