...
class TestEntropyDeterminism:
    ...
    def test_3x_replay_word_len_2(self, prices_100):
        from qlx.features.information import price_entropy
...
class TestMutualInfoDeterminism:
    ...
    def test_3x_replay(self, prices_100):
        from qlx.features.information import mutual_information
...
class TestRollingFeatureDeterminism:
    ...
    def test_rolling_entropy_3x(self, prices_300):
        from qlx.features.information import rolling_entropy
    ...
    def test_rolling_mi_3x(self, prices_300):
        from qlx.features.information import rolling_mutual_info
...
class TestVPINFromTicksDeterminism:
    ...
    def test_3x_replay(self, tick_prices):
        from qlx.features.microstructure import vpin_from_ticks
...
class TestTickEntropyDeterminism:
    def test_3x_replay(self, tick_prices):
        from qlx.features.microstructure import tick_entropy
...
class TestHawkesDeterminism:
    def test_3x_replay(self):
        from qlx.features.microstructure import trade_arrival_hawkes
...
class TestRiskManagerDeterminism:
    ...
    def test_3x_replay_pass(self):
        from qlx.allocator.meta import TargetPosition
        from qlx.risk.limits import RiskLimits
        from qlx.risk.manager import GateResult, PortfolioState, RiskManager
...
class TestPortfolioStateDeterminism:
    def test_dd_3x(self):
        from qlx.risk.manager import PortfolioState
