...
Usage:
    python -m brahmastra paper --once              # single day scan
    python -m brahmastra paper --date 2026-02-05
    python -m brahmastra paper --range 2025-01-01 2026-01-31
    python -m brahmastra replay --date 2025-08-06  # replay single date
    python -m brahmastra replay --range 2025-08-06 2025-12-31
    python -m brahmastra replay --range START END --times 3  # 3x parity
    python -m brahmastra status                    # portfolio status
    python -m brahmastra live                      # (future: live trading)
"""
...
def cmd_paper(args: argparse.Namespace) -> None:
    ...
    from qlx.allocator.meta import MetaAllocator
    from qlx.risk.manager import RiskManager
    from brahmastra.orchestrator import Orchestrator
...
def cmd_replay(args: argparse.Namespace) -> None:
    ...
    from qlx.data.store import MarketDataStore
    from qlx.strategy.registry import StrategyRegistry
    from brahmastra.replay.engine import ReplayEngine
...
def main() -> None:
    ...
    if args.command == "paper":
        ...
        raise NotImplementedError(
            ...
            "Use 'brahmastra paper' for paper trading."
        )
    else:
        parser.print_help()
