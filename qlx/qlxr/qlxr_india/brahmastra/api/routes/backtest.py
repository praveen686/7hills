...
class BacktestTracker:
    """Thread-safe tracker for async backtest jobs."""
...
def _run_s2(store, start: date, end: date, p: dict) -> dict:
    ...
    """
    from qlx.features.ramanujan import ramanujan_periodogram, ramanujan_sum
...
def _run_s5(store, start: date, end: date, p: dict) -> dict:
    ...
    from research.s5_tick_microstructure import _load_day_data, _backtest_feature
...
def _run_s6(store, start: date, end: date, p: dict) -> dict:
    ...
    from research.s6_multi_factor import _build_feature_matrix, _walk_forward_backtest
...
def _run_s7(store, start: date, end: date, p: dict) -> dict:
    ...
    from research.s7_regime_switch import backtest_regime_switch
...
def _run_s10(store, start: date, end: date, p: dict) -> dict:
    ...
    from research.s10_gamma_scalp import backtest_gamma_scalp
...
def _run_s11(store, start: date, end: date, p: dict) -> dict:
    ...
    from research.s11_pairs import backtest_pairs
