...
Classifies market into TRENDING / MEAN_REVERTING / RANDOM using:
  - Shannon entropy (distribution shape) from qlx/features/information.py
  - Mutual Information (predictability) from qlx/features/information.py
  - VPIN (microstructure toxicity) from qlx/features/microstructure.py
...
from qlx.features.information import price_entropy, mutual_information
