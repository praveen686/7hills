...
from apps.india_data.headline_archive import archive_headlines
from apps.india_news.scraper import scan_india_news
from apps.india_news.state import DEFAULT_STATE_FILE, IndiaNewsTradingState
...
def _load_classifier():
    ...
    from qlx.nlp.sentiment import get_classifier
