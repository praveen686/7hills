...
mod tests {
    ...
    fn test_load_real_strategies_manifest() {
        ...
        let manifest_path = PathBuf::from("configs/strategies_manifest.json");
    ...
    fn test_real_manifests_signal_binding() {
        ...
        let signals_path = PathBuf::from("configs/signals_manifest.json");
        let strategies_path = PathBuf::from("configs/strategies_manifest.json");
