...
from quantlaxmi.strategies.s12_vedic_ffpe.signals import (
    compute_daily_signal,
    compute_features_array,
    classify_regime,
)
from quantlaxmi.strategies.s12_vedic_ffpe.intraday_engine import run_intraday
...
def run_math_first(store: MarketDataStore, symbols: list[str],
    ...
    for symbol in symbols:
        ...
        if use_gpu and _GPU_AVAILABLE:
            from quantlaxmi.strategies.s12_vedic_ffpe.gpu_features import (
...
def _load_kite_vix(start: str = "2024-01-01") -> tuple[np.ndarray, list]:
    ...
    from quantlaxmi.data.zerodha import fetch_historical
