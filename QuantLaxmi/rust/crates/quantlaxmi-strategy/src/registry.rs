...
use crate::Strategy;
use crate::strategies::crt_omega::{CRT_OMEGA_NAME, crt_omega_factory};
...
use crate::strategies::slr::{SLR_NAME, slr_factory};
...
impl StrategyRegistry {
    ...
    pub fn with_builtins() -> Self {
        ...
        registry.register(CRT_OMEGA_NAME, crt_omega_factory);
        registry.register(
        ...
        registry.register(SLR_NAME, slr_factory);
