...
mod tests {
    ...
    fn test_g3_real_manifests() {
        ...
        let signals_path = std::path::PathBuf::from(format!("{}/signals_manifest.json", config_root));
        let strategies_path = std::path::PathBuf::from(format!("{}/strategies_manifest.json", config_root));
