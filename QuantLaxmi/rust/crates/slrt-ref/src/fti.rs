...
impl FTITracker {
    ...
    fn calibrate(&mut self) {
        ...
        if calibrated_threshold > 0.0 {
            eprintln!(
                "FTI: Calibrated persist_threshold = {:.4} (p{:.0} of {} samples)",
