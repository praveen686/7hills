...
3. **HawkesOptimalStopping**: Finite-horizon MDP for S5 Hawkes strategy exit
   ...
   solved via value_iteration from models.rl.core.dynamic_programming.
...
from models.rl.agents.execution_agent import OptimalExecutionAgent
from models.rl.environments.execution_env import ExecutionEnv, LOBSimulator
from models.rl.finance.optimal_execution import AlmgrenChrissSolution
