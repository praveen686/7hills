...
from models.rl.integration.backbone import XTrendBackbone, MegaFeatureAdapter
from models.rl.finance.asset_allocation import MertonSolution, AssetAllocationMDP
from models.rl.environments.india_fno_env import COST_PER_LEG, INITIAL_SPOTS
...
class CryptoFeatureAdapter:
    ...
    data_root : Path or None
        ...
        Default: reads from data._paths.BINANCE_DIR.
    """
    ...
    def __init__(
        ...
        if data_root is None:
            from data._paths import BINANCE_DIR
