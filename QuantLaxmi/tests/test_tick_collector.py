...
from quantlaxmi.data.collectors.crypto_tick.collector import CollectorConfig, scan_symbols
from quantlaxmi.data.collectors.crypto_tick.features import LiveRegimeTracker, SymbolFeatureState
from quantlaxmi.data.collectors.crypto_tick.storage import (
    BOOK_SCHEMA,
    TRADE_SCHEMA,
    BookTick,
    TickStore,
...
class TestScanner:
    def test_scan_filters_by_funding(self):
        ...
        with patch("quantlaxmi.data.collectors.crypto_tick.collector.requests.get") as mock_get:
