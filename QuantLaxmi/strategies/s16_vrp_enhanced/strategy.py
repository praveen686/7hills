...
Realized vol:
    HAR-RV model (1-day, 5-day, 22-day components) from core.pricing.iv_engine.
...
from core.pricing.iv_engine import compute_chain_iv, har_rv, OptionChainIV
...
def _get_sanos_left_tail(
    ...
    try:
        ...
        from core.pricing.risk_neutral import compute_snapshot
