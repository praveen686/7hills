...
from data.collectors.news.headline_archive import archive_headlines
from data.collectors.news.scraper import scan_india_news
from data.collectors.news.state import DEFAULT_STATE_FILE, IndiaNewsTradingState
...
def _load_classifier():
    ...
    from core.nlp.sentiment import get_classifier
