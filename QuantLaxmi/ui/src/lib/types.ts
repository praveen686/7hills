...
export interface MissedOpportunity {
  ...
  entry_price: number;
  hypothetical_exit_price: number;
  hypothetical_pnl_pct: number;
  hypothetical_mfm: number;
...
export interface MissedSummary {
  [strategyId: string]: {
    ...
    total_hypothetical_pnl_pct: number;
