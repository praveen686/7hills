...
Usage:
    python -m apps.tick_collector collect              # run live collector
    python -m apps.tick_collector collect --duration 60 # collect for 60 seconds
    python -m apps.tick_collector status               # show stored data stats
    python -m apps.tick_collector read BTCUSDT          # read today's ticks
    python -m apps.tick_collector read BTCUSDT --date 2026-02-05
"""
...
from apps.tick_collector.collector import CollectorConfig, TickCollector, scan_symbols
