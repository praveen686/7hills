...
pub trait Strategy: Send {
    ...
    /// Print strategy-specific diagnostics (funnel stats, etc.).
    ///
    /// Called by engine at end of backtest for tuning visibility.
    /// Default: no-op
    fn print_diagnostics(&self) {
        // Default: no-op - override in strategy implementations
    }
