...
pub mod sealed {
    ...
    /// Normalization warmup: 30 seconds (TESTING - spec says 5 minutes)
    pub const WARMUP_DURATION_SECS: u64 = 30;

    /// Normalization warmup: 1,000 ticks minimum (TESTING - spec says 30,000)
    pub const WARMUP_MIN_TICKS: usize = 1_000;
