...
// Use unified simulator from executor crate
...
// NOTE: MarketState and Position types are in quantlaxmi_executor::sim
...
///
/// NOTE: This is now a thin wrapper around `quantlaxmi_executor::sim::Simulator` which provides
